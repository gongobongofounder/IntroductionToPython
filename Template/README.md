Here are the script links for various languages supported by Prism.js. You can include these in your HTML file to enable syntax highlighting for each respective language:
